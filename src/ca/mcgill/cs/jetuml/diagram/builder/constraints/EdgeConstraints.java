...
public final class EdgeConstraints
{
	 ...
	 */
	public static Constraint maxEdges(Diagram pDiagram, int pNumber)
	{
		assert pNumber > 0;
		return (Edge pEdge, Node pStart, Node pEnd, Point pStartPoint, Point pEndPoint)->
		{
	...
	{
		return (Edge pEdge, Node pStart, Node pEnd, Point pStartPoint, Point pEndPoint)-> { return pStart != pEnd; };
	}
